  ...
  return (
    <Modal show={show} onHide={close}>
      <Modal.Header>
        ...
        <img className=" modal-image-mobile" src={isChrome ? brother.image : brother.safari} alt="Active" />
      </Modal.Header>
      <Modal.Body>
        <img className=" modal-image" src={isChrome ? brother.image : brother.safari} alt="Active" />
        <BrotherInfo>
          <Info>
